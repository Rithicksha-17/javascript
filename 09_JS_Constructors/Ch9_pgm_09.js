...
// 1) Create a couple of Player objects
var player2 = new Player("Jovan", 60);
var player3 = new Player("Arya", 70);

// 2) Add items for each player
player2.addItem("a golden ring");
player2.addItem("a healing potion");
player3.addItem("a dagger");
player3.addItem("a cloak of invisibility");
...
console.log(player1.dropItem()); 
console.log(player2.dropItem()); 
console.log(player3.dropItem()); 
